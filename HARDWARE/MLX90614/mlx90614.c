...
#define SMBUS_PORT_SCK	    GPIOA      //PB端口(端口和下面的两个针脚可自定义)
#define SMBUS_PORT_SDA	    GPIOC      //PB端口(端口和下面的两个针脚可自定义)
...
#define SMBUS_SCK_H()	    SMBUS_PORT_SCK->BSRR = SMBUS_SCK //置高电平
#define SMBUS_SCK_L()	    SMBUS_PORT_SCK->BRR = SMBUS_SCK  //置低电平
